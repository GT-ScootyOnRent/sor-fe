...
const buttonVariants = cva(
  // cursor-pointer is explicit: Tailwind v4's Preflight dropped the v3 rule that gave
  // <button> a pointer cursor, so buttons otherwise fall back to the browser default
  // arrow and don't look clickable.
